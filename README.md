...
We are an open-source project, so if you would like to make a change or add something feel free to open a pull request! Also check out our [Acknowledgements page](https://github.com/CaenJones/ChromeSEC/blob/main/Acknowledgements.md).
