...
**NOTE:** While most guides recommend blocking [uBlock Origin](https://github.com/gorhill/ublock) ([Webstore Link](https://chromewebstore.google.com/detail/cjpalhdlnbpafiamejdnhcphjbkeiagm)) and might recommend [uBlock Origin Lite](https://github.com/uBlockOrigin/uBOL-home) ([Webstore Link](https://chromewebstore.google.com/detail/ddkjiahejlhfcafbddmgiahcphecmpfh)), it is possible to restrict uBlock Origin in what it is and is not allowed to do. More details can be found [here](https://github.com/gorhill/ublock/wiki/Deploying-uBlock-Origin). It is to be noted that lots of adblockers provide functionality to execute scripts on a page, like [AdGuard](https://adguard.com/) ([Webstore Link](https://chromewebstore.google.com/detail/bgnkhhnnamicmpeenaelnjfhikgbkllg)).
